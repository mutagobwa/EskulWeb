...
{
    public class SubjectMarkSheetController : BaseController
    {
        ...
        // GET: SubjectMarkSheetController
        public SubjectMarkSheetController(IConfiguration configuration, ILoggerErr logger, MyUtilities myUtilities)
        {
        ...
        public async Task<ActionResult> Index(SubmarkVm model)
        {
...

            {
                ...
                if (model.Class > 0)
                {
                    ...
                    string Url = "Examination/MarkSheet/Subject/Get/" + model.Year + "/" + model.TermCode + "/" + model.Class + "/" + model.Stream + "/" + model.SubjectCode + "/" + model.PaperCode + "/" + model.ExamCode;
        ...
        public async Task<IActionResult> PrintSubjectMarkSheet(SubmarkVm model)
        {
            ...
            {
                model.PaperCode = model.PaperCode.Replace("/", "-");
                string url = $"Examination/MarkSheet/Subject/WritePDF/{model.Year}/{model.TermCode}/{model.Class}/{model.Stream}/{model.SubjectCode}/{model.PaperCode}/{model.ExamCode}";
